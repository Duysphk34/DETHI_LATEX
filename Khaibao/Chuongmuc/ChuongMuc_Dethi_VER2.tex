...
\resizebox{\linewidth}{!}{
	...
	{\color{\mycolor!30!black}\myfont\resizebox{6cm}{12pt}{\MakeUppercase{\sophong}}}
	&&
	{\color{\mycolor!30!black}\myfont\resizebox{6cm}{12pt}{\MakeUppercase{#1}}}\\
	{\color{\mycolor!30!black}\myfont\resizebox{4.5cm}{10pt}{\MakeUppercase{\truong}}}
	&&
	{\color{\mycolor!30!black}\myfont \resizebox{4.0cm}{9pt}{Năm học: \nh}}\\
	{\color{\mycolor!30!black}\textbf{\loaide}}
	&&
	{\bfseries\sffamily Môn: \monhoc\ -- Lớp: \lop}\\
	{\hypersetup{linkcolor=\mycolor!30!black} (\textit{Đề thi có \pageref{LastPage} trang})}
	&&
...
%		\resizebox{\linewidth}{!}{
%			\begin{tabular}{cc}
%				{\color{\mycolor}\bfseries\sffamily\resizebox{6cm}{12pt}{\MakeUppercase{\phongban}}}
%				&
%				{\color{\mycolor}\bfseries\sffamily\resizebox{8.5cm}{17pt}{\MakeUppercase{#1}}}\\					
%				{\color{\mycolor}\bfseries\selectfont \textbf{ĐỀ SỐ \circlenumH[\mycolor]{\fontfamily{ugq}\selectfont\Large\thedemsode }}}
%				&
%				{\bfseries\sffamily Môn: \monhoc\ -- Lớp: \lop}\\
%				{\hypersetup{linkcolor=\mycolor} (\textit{đề thi có \pageref{LastPage} trang})}&
%				{Thời gian: \textbf{\thoigian}\ phút (\textit{không kể phát đề})} 
%		\end{tabular}}
%	\end{tcolorbox} %
%	\vspace*{-23pt}
